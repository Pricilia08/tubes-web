                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a href="view_berita.php" data-toggle="collapse" data-target="#Charts" >Berita <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
