                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Berita" href="index1.php?isi=view_berita"><span class="mini-sub-pro">All Berita</span></a></li>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="breadcome-heading">
                                            <form action="search_pengguna.php" method="post" class="sr-input-func">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="view_pengguna.php">View Pengguna</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <?php  
                                        ...
                                        $cari = $_POST['cari'];
                                        $sql = "select * from pengguna where nama_vol like '%".$cari."%'";
