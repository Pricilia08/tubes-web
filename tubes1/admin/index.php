...
<head>
    ...
    <title>Dashboard | Petshelter</title>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="index1.html" aria-expanded="false"><span class="educate-icon educate-library icon-wrap"></span> <span class="mini-click-non">Berita</span></a>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <?php
                                ...
                                $sqluser = "SELECT COUNT(*) from pengguna";
                                $hasil = mysqli_query($conn,$sqluser);
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <?php
                                include ("../include/config.php");
                                $sqlberita = "SELECT COUNT(*) from berita";
                                $hasil = mysqli_query($conn,$sqlberita);
                                $baris = mysqli_fetch_array($hasil)[0];
                            ?>
                            <div class="analytics-sparkle-line reso-mg-b-30">
                                <div class="analytics-content">
                                    <h5>All berita</h5>
                                    <h2><span class="counter"><?php echo $baris; ?></span></h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <?php
                                include ("../include/config.php");
                                $sqlvolunteer = "SELECT COUNT(*) from volunteer";
                                $hasil = mysqli_query($conn,$sqlvolunteer);
                                $query = mysqli_fetch_array($hasil)[0];
                            ?>
                            <div class="analytics-sparkle-line reso-mg-b-30">
                                <div class="analytics-content">
                                    <h5>All Volunteer</h5>
                                    <h2><span class="counter"><?php echo $query; ?></span></h2>
                                </div>
                            </div>
                        </div>
                        </div>
