                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="breadcome-heading">
                                            <form action="search_volunteer.php" method="post" class="sr-input-func">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="view_volunteer.php">View Volunteer</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <?php  
                                        ...
                                        $total_pages_sql = "SELECT COUNT(*) FROM volunteer";
                                        $result = mysqli_query($conn,$total_pages_sql);
                                        $total_rows = mysqli_fetch_array($result)[0];
                                        $total_pages = ceil($total_rows / $no_of_records_per_page);

                                        $sql = "SELECT * FROM volunteer order by id_vol LIMIT $offset, $no_of_records_per_page";
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $note;  ?></td>
                                        <td>
                                            <a href="delete_volunteer.php?del=<?php echo $id_vol ?>">
